        ...
        <div class="row row-pb-lg product-detail-wrap">
            <div class="col-sm-8">
                <div class="owl-carousel">
                    <div class="item">
                        <div class="product-entry border" style="height: 545px !important; width: 545px;" >
                            <a href="#" class="prod-img" style="transform: translateZ(0px); position: absolute; left: 0px; top: 0px; height: 545px; width: 545px; overflow: hidden;">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh1'] ?>" class="img-fluid" alt="QUAN PHUONG code ">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border" style="height: 545px !important; width: 545px;">
                            <a href="#" class="prod-img" style="transform: translateZ(0px); position: absolute; left: 0px; top: 0px; height: 545px; width: 545px; overflow: hidden;">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh2'] ?>" class="img-fluid" alt="QUAN PHUONG code ">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border" style="height: 545px !important; width: 545px;">
                            <a href="#" class="prod-img" style="transform: translateZ(0px); position: absolute; left: 0px; top: 0px; height: 545px; width: 545px; overflow: hidden;">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh3'] ?>" class="img-fluid" alt="QUAN PHUONG code ">
                            </a>
                        </div>
                    </div>
                    <div class="item">
                        <div class="product-entry border" style="height: 545px !important; width: 545px;">
                            <a href="#" class="prod-img" style="transform: translateZ(0px); position: absolute; left: 0px; top: 0px; height: 545px; width: 545px; overflow: hidden;">
                                <img src="webroot/image/sanpham/<?php echo $product_detail_image['Anh4'] ?>" class="img-fluid" alt="QUAN PHUONG code ">
                            </a>
                        </div>
                    </div>
                </div>

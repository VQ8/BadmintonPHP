...
<div class="container-fluid">
	<div class=" alert alert-primary">
	  	<h4 class="page-title">
		    ...
		    </span> ADMIN - Clac Clac SHOES &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Doanh Thu&#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Tháng <?php echo $thang.' / '. $nam ?>
		</h4>
	</div><br>	

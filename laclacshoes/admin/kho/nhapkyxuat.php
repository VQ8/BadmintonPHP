...
<div class="container-fluid">
	<div class="page-header">
	  <h4 class="page-title">
	    ...
	    </span> QP BADMINTON &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Kho Hàng &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Nhật ký xuất kho</h4>
	</div><hr><br>
	<div class="row">

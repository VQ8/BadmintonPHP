	...
	<div class="container-fluid">
		...
		<div class=" alert alert-primary">
		  <h4 class="page-title">
		    ...
		    </span> ADMIN - CLAC CLAC SHOES &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Kho Hàng &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160;Xuất / Nhập Kho &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $t ?> &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $mau ?></h4>
		</div><br>
		<div class="row">
			<div class="col-md-5">

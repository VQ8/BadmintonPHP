...
<div class="container-fluid">
    <div class=" alert alert-primary">
      <h4 class="page-title">
        ...
        </span> ADMIN - CLAC CLAC SHOES &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Khuyến mãi&#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Apply &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $kq['TenKM'] ?></h4>
    </div>
</div>

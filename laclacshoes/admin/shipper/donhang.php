...
<div class="container-fluid">
	<div class=" alert alert-primary">
	  <h4 class="page-title">
	    ...
	    </span> ADMIN - QP Badminton &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; Giao Hàng &#160;<i class="fas fa-chevron-right" style="font-size: 18px"></i>&#160; <?php echo $dk ?></h4>
	</div>
	<br>
	<div class="row">
